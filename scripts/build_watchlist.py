...
/* Left nav */
.sidenav{width:160px;flex-shrink:0;background:var(--bg2);
  border-right:1px solid rgba(255,255,255,0.06);padding:16px 0;
  position:sticky;top:0;align-self:flex-start;height:calc(100vh - 130px);
...
<div class="layout">
  ...
  <div class="tab-content" id="tab-hot"><div class="body"><div class="cards">{ch(hot)}</div></div></div>
  <div class="tab-content" id="tab-warm"><div class="body"><div class="cards">{ch(warm)}</div></div></div>
  <div class="tab-content" id="tab-watch"><div class="body"><div class="cards">{ch(watch)}</div></div></div>
